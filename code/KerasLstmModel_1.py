...
"""
Lstm network (3 inputs <300,300,600>) with shared weights of q,a input in word2vect and other input  with the sum of q and a vectors concatenated
"""
class KerasLstmModel_1(models.PassageRetrievalModel):

    def __init__(self,init_params):
        super(KerasLstmModel_1, self).__init__('KerasLstmModel_1', init_params['runid'])
    ...
    def train(self, ds, qa_pair):
        ...
        logger.info( 'Start Trainning with ' + str(len(qa_pair['train'])) + ' samples')
        # checkpoints
        ...
        history = self.model.fit_generator(
                    ...
                    callbacks=[checkpoint, earlyStopping],nb_worker=1)
        return history
