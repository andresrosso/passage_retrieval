...
"""
Lstm network (3 inputs <300,300,300>) with shared weights of q,a input in word2vect and other input  with the element wise multiplication of q and a vectors
"""
class KerasLstmModel_2(models.PassageRetrievalModel):
    
    def __init__(self,init_params):
        super(KerasLstmModel_2, self).__init__('KerasLstmModel_2', init_params['runid'])
    ...
    def proc_third_input(self, q, a):
        ...
        try:
            ...
            res = np.multiply( sum(np.array(q_w2v)), sum(np.array(a_w2v)) )
            return res
        except Exception, e:
            print e
